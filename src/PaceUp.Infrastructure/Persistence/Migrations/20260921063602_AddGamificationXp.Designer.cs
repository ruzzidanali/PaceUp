...
namespace PaceUp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921063602_AddGamificationXp")]
    partial class AddGamificationXp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaceUp.Domain.Entities.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PaceUp.Domain.Entities.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PaceUp.Domain.Entities.UserGamification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserGamifications", (string)null);
                });
            ...
            modelBuilder.Entity("PaceUp.Domain.Entities.XpTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PaceUp.Domain.Entities.UserAchievement", b =>
                {
                    b.HasOne("PaceUp.Domain.Entities.Achievement", "Achievement")
